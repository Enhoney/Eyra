...
#include "EyraExperienceDefinition.generated.h"

class UGameFeatureAction;
class UEyraPawnData;
class UEyraExperienceActionSet;

/**
* UEyraExperienceDefinition
* 游戏体验的定义
*
*/

UCLASS(BlueprintType, Const)
class UEyraExperienceDefinition : public UPrimaryDataAsset
{
    GENERATED_BODY()
...
public:
	...
	//@待办事项：做成软引用？
	UPROPERTY(EditDefaultsOnly, Category = Gameplay)
	TObjectPtr<const UEyraPawnData> DefaultPawnData;
	...
	// List of additional sets of actions that make up this experience
	// 用于构成此体验的附加操作集列表
	UPROPERTY(EditDefaultsOnly, Category = Gameplay)
	TArray<TObjectPtr<UEyraExperienceActionSet>> ActionSets;
};
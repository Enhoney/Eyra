...
#include "EyraWorldSettings.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class AEyraWorldSettings : public AWorldSettings
{
	GENERATED_BODY()

public:

	UE_API AEyraWorldSettings(const FObjectInitializer& ObjectInitializer);
...
protected:
	...
	TSoftClassPtr<UEyraExperienceDefinition> DefaultGameplayExperience;
